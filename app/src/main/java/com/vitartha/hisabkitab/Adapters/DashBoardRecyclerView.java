...
public class DashBoardRecyclerView extends RecyclerView.Adapter<DashBoardRecyclerView.MyViewHolder> implements View.OnClickListener {
    ...
    public DashBoardRecyclerView(List<DebitDetails> Debitdetails, Context context) {
        debitDetailsList = Debitdetails;
        this.mcontext = context;
    }

    @Override
    public DashBoardRecyclerView.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_debitt_recyclerview, parent, false);

        return new DashBoardRecyclerView.MyViewHolder(itemView);

    }

    @Override
    public void onBindViewHolder(DashBoardRecyclerView.MyViewHolder holder, final int position) {
